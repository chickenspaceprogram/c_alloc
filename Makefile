...
UNIXFLAGS=-DC_ALLOC_DBGFLAGS=ON -DCMAKE_EXPORT_COMPILE_COMMANDS=ON
STATIC_TOOLS=-DC_ALLOC_CLANG_TIDY=ON -DC_ALLOC_CPPCHECK=ON
ASAN=-DC_ALLOC_USE_ASAN=ON
TESTS=-DC_ALLOC_TESTS=ON
